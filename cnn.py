...
def deepnn(x):
    ...
    # TODO: Test third convolutional layer -- maps 32 feature maps to 64.
    with tf.name_scope('conv3'):
        W_conv3 = weight_variable([5, 5, 64, 64])  # TODO: #filters, filter size/ depth
        ...
        with tf.Session() as sess:
            ...
            for i in range(epochs):
                for (Xb, Yb) in next_batch(cnnData.X_train, cnnData.Y_train, batchSize):
                    train_step.run(feed_dict={x: Xb, y_: Yb, keep_prob: 0.5})  # TODO: dropout keep_prob
